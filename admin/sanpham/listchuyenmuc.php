        ...
        <div class="modal-content">
          <div class="modal-body">
            <form action='index.php?act=adddanhmuc' method="POST" enctype="multipart/form-data">
              ...
              <br />
              <input class="btn btn-save" type="submit" name="themmoidm" value="Thêm">
              <!-- <button class="btn btn-save" type="submit" name="themmoi">Thêm</button> -->
        ...
        <div class="modal-content">
          ...
          <div class="swal-footer">
            <div class="justify-content-center d-flex m-3">
              ...
              <button class="btn btn-save" name="xoaloai">Xóa</button>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="tile">
            <div class="tile-body">
              ...
              >
                ...
                <form action="index.php?act=listchuyenmuc" method="post">
                    <input type="text" name="keyw" class="form-control form-control-sm" placeholder="Nhập value tìm kiếm">
      
                    <input type="submit" name="clickOK" value="Lọc danh mục" class="loc-sp-list">
                </form>
                </div>
              </div>
                </div>
                    ...
                    >
                      <thead>
                        ...
                        <th
                          ...
                          <th
                            ...
                            rowspan="1"
                            colspan="1"
                            aria-label="Tên danh mục: kích hoạt để sắp xếp cột tăng dần"
                            style="width: 961.2px"
                          >
                            <font style="vertical-align: inherit"
                              ><font style="vertical-align: inherit"
                      ...
                      <tbody>
                        ...
                        if (empty($danhmuc)) {
                          ...
                          foreach ($danhmuc as $loaidanhmuc) {
                            extract($loaidanhmuc);
                          ...
                          ';
                          $xoa = "index.php?act=xoaloai&idloai=".$id_loai;
                          $sua = "index.php?act=apdanhmuc&idloaihang=".$id_loai;
                          echo'
                          <a href="'.$xoa.'">
              ...
              <div class="col-sm-12 col-md-5">
                <div class="dataTables_info" id="sampleTable_info" role="status" aria-live="polite">
                  <font style="vertical-align: inherit">
                    <font style="vertical-align: inherit">Hiển thị 1 đến <?=$tongbanghi=count($danhmuc);?> trên <?=$tongdanhmuc=count($tongsodm);?> mục</font>
                  </font>
                </div>
              </div>
              <?php 
              $tranght = $_GET['page'] ?? 1; 
              $lui = max(1, $tranght-1);
              $tiep = min($sotrangdm, $tranght+1);
              ?>
              <div class="col-sm-12 col-md-7">
                <div class="dataTables_paginate paging_simple_numbers" id="sampleTable_paginate">
                  <ul class="pagination">
                    <li class="paginate_button page-item previous" id="sampleTable_previous">
                      <a href="index.php?act=listchuyenmuc&page=<?=$lui?>" aria-controls="sampleTable" data-dt-idx="0" tabindex="0" class="page-link">
                        <font style="vertical-align: inherit">
                    ...
                    <li class="paginate_button page-item next" id="sampleTable_next">
                      <a href="index.php?act=listchuyenmuc&page=<?=$tiep?>" aria-controls="sampleTable" data-dt-idx="2" tabindex="0" class="page-link">
                        <font style="vertical-align: inherit">
